        ...
        <div class="card mb-3 w-50 mx-auto">
            <div class="card-body">
                <form action="{{url('/pasien/janji/confirm')}}" class="form-inline" method="post">
                    ...
                    <br>
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="NotifSubmit">Submit</button>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Form Already Sumbitted!</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    Tolong tunggu pemberitahuan selanjutnya!
                                </div>
                                </div>
                            </div>
                        </div>
